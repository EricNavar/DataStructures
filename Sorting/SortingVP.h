...
#include <vector>
using namespace std;
//This file contains sorting algorithms that sort vectors 
//containing pointers to elements. The comparison is done
//based on the value of the elements, not the pointers
